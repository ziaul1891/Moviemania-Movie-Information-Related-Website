...
function findmatch(){
	...
	xmlhttp.open('GET','searchaction.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=52"><img src="data1/images/movieimageaction2.jpg" alt="movieimage2" title="movieimage2" id="wows1_1"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=55"><img src="data1/images/movieimageaction3.jpg" alt="movieimage3" title="movieimage3" id="wows1_2"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=60"><img src="data1/images/movieimageaction4.jpg" alt="movieimage4" title="movieimage4" id="wows1_3"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=47"><img src="data1/images/movieimageaction5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=37"><img src="data1/images/movieimageaction6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=48"><img src="data1/images/movieimageaction7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM horror where Category='action' ORDER BY FirstName asc ";
