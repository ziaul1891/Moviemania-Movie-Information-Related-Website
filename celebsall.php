...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM celebs ORDER BY FirstName asc ";
		...
		while($query_row = mysql_fetch_array($query_run)){
			...
			echo "<font size=3>" . "<a href='resultcelebs.php?id=$id'>$name $name1 $name2<br /><br/></a>" . "</font>";
