...
$user=$_SESSION["userid"];
	...
	";
			...
			echo "<font color='#945'>Rating : ".number_format($finalrate,2)."</font><br/><br/>";
			...
			echo "<font color='#945'>Rating : Please <a href='login.php'>Login</a> to rate or see the rating</font>";
		}
		
		
		
		echo "<br><br><a href='animation.php' >Go Back</a><br />";
