...
function findmatch(){
	...
	xmlhttp.open('GET','searchcomedy.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=186"><img src="data1/images/movieimagecomedy1.jpg" alt="movieimage1" title="movieimage1" id="wows1_0"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=161"><img src="data1/images/movieimagecomedy2.jpg" alt="movieimage2" title="movieimage2" id="wows1_1"/></a></li>
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=195"><img src="data1/images/movieimagecomedy4.jpg" alt="movieimage4" title="movieimage4" id="wows1_3"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=178"><img src="data1/images/movieimagecomedy5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=172"><img src="data1/images/movieimagecomedy6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=194"><img src="data1/images/movieimagecomedy7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM horror where Category='comedy' ORDER BY FirstName asc ";
