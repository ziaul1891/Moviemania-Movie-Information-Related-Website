...
function findmatch(){
	...
	xmlhttp.open('GET','searchdrama.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=280"><img src="data1/images/movieimagedrama1.jpg" alt="movieimage1" title="movieimage1" id="wows1_0"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=309"><img src="data1/images/movieimagedrama2.jpg" alt="movieimage2" title="movieimage2" id="wows1_1"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=314"><img src="data1/images/movieimagedrama3.jpg" alt="movieimage3" title="movieimage3" id="wows1_2"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=282"><img src="data1/images/movieimagedrama4.jpg" alt="movieimage4" title="movieimage4" id="wows1_3"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=316"><img src="data1/images/movieimagedrama5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=288"><img src="data1/images/movieimagedrama6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=310"><img src="data1/images/movieimagedrama7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM horror where Category='drama' ORDER BY FirstName asc ";
		...
		while($query_row = mysql_fetch_array($query_run)){
			...
			echo "<font size=3>" . "<a href='resulthorror.php?id=$id'>$name $name1 $name2<br /><br/></a>" . "</font>";
