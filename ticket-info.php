...
function findmatch(){
	...
	xmlhttp.open('GET','searchcelebs.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=17"><img src="data1/images/celebsimage1.jpg" alt="movieimage1" title="movieimage1" id="wows1_0"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=26"><img src="data1/images/celebsimage2.jpg" alt="movieimage2" title="movieimage2" id="wows1_1"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=21"><img src="data1/images/celebsimage3.jpg" alt="movieimage3" title="movieimage3" id="wows1_2"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=1"><img src="data1/images/celebsimage4.jpg" alt="movieimage4" title="movieimage4" id="wows1_3"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=6"><img src="data1/images/celebsimage5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=27"><img src="data1/images/celebsimage6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resultcelebs.php?id=13"><img src="data1/images/celebsimage7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT * from (
   SELECT ID,FirstName,MiddleName,LastName  FROM celebs 
...
LIMIT 15";
		...
		while($query_row = mysql_fetch_array($query_run)){
			...
			echo "<font size=3>" . "<a href='resultcelebs.php?id=$id'>$name $name1 $name2<br /></a>" . "</font>";
...
echo "<a href='./celebsall.php'>(more...)</a>";
?>
<h3>Refresh the page for 15 more random Celebrities or search from below</h3>
