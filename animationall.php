...
function findmatch(){
	...
	xmlhttp.open('GET','searchanimation.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=122"><img src="data1/images/movieimageanimation1.jpg" alt="movieimage1" title="movieimage1" id="wows1_0"/></a></li>
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=96"><img src="data1/images/movieimageanimation3.jpg" alt="movieimage3" title="movieimage3" id="wows1_2"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=93"><img src="data1/images/movieimageanimation4.jpg" alt="movieimage4" title="movieimage4" id="wows1_3"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=103"><img src="data1/images/movieimageanimation5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=126"><img src="data1/images/movieimageanimation6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=102"><img src="data1/images/movieimageanimation7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM horror where Category='animation' ORDER BY FirstName asc ";
