...
function findmatch(){
	...
	xmlhttp.open('GET','searchdocumentary.inc.php?search_text='+document.search.search_text.value,true);
	xmlhttp.send();
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=248"><img src="data1/images/movieimagedocumentary1.jpg" alt="movieimage1" title="movieimage1" id="wows1_0"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=247"><img src="data1/images/movieimagedocumentary2.jpg" alt="movieimage2" title="movieimage2" id="wows1_1"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=226"><img src="data1/images/movieimagedocumentary3.jpg" alt="movieimage3" title="movieimage3" id="wows1_2"/></a></li>
...
<li><a href="http://localhost/onlyrating/resulthorror.php?id=254"><img src="data1/images/movieimagedocumentary5.jpg" alt="movieimage5" title="movieimage5" id="wows1_4"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=243"><img src="data1/images/movieimagedocumentary6.jpg" alt="movieimage6" title="movieimage6" id="wows1_5"/></a></li>
<li><a href="http://localhost/onlyrating/resulthorror.php?id=256"><img src="data1/images/movieimagedocumentary7.jpg" alt="movieimage7" title="movieimage7" id="wows1_6"/></a></li>
</ul></div>
...
if ($con=mysql_connect('localhost','root','')){
	if($con=mysql_select_db('newdb')){
		...
		$query = "SELECT ID,FirstName,MiddleName,LastName FROM horror where Category='documentary' ORDER BY FirstName asc ";
